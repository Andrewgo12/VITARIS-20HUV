...
export default function Login() {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      // VITAL RED authentication with role-based routing
      ...
      if (response.success && response.data) {
        ...
        localStorage.setItem('vitaris_token', response.data.token);

        addNotification({
          type: 'success',
          title: 'Login Exitoso',
          message: `Bienvenido al sistema VITAL RED, ${response.data.user.name}!`,
          priority: 'medium'
        });

        // Role-based navigation
        if (userType === "MEDICAL_EVALUATOR") {
          navigate("/vital-red/dashboard");
  ...
  const userTypeInfo = {
    MEDICAL_EVALUATOR: {
      icon: User,
      title: "Médico Evaluador",
      description: "Evaluación y decisión sobre casos médicos",
      color: "text-blue-600",
    ...
    ADMINISTRATOR: {
      ...
      description: "Gestión completa del sistema VITAL RED",
                ...
                <form onSubmit={handleLogin} className="space-y-6">
                  ...
                  <div className="space-y-3">
                    ...
                    >
                      ...
                      <SelectContent>
                        <SelectItem value="MEDICAL_EVALUATOR">
                  ...
                  {userType && (
                    <Alert>
                      ...
                      <AlertDescription>
                        <strong>Credenciales de Demo VITAL RED:</strong><br />
                        {userType === "MEDICAL_EVALUATOR" && (
                          <>Médico Evaluador: medico@vitalred.com / Medico123!</>
                        )}
