...
const mockBackups: BackupItem[] = [
  ...
  },
  {
    ...
    status: 'completed',
    location: 'local',
    description: 'Backup incremental de historias clínicas y datos de pacientes',
    duration: 8,
      ...
      const interval = setInterval(() => {
        setBackupProgress(prev => {
          if (prev >= 100) {
            ...
            setNewBackup({ name: '', type: 'full', location: 'cloud', description: '' });
            return 0;
          }
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h2 className="text-2xl font-bold tracking-tight">Sistema de Backup</h2>
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">
              {backups.filter(b => b.status === 'completed').length} completados
            </p>
          </CardContent>
        </Card>
      ...
      <Dialog open={showRestoreDialog} onOpenChange={setShowRestoreDialog}>
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              ¿Estás seguro de que quieres restaurar este backup? Esta acción sobrescribirá los datos actuales.
            </DialogDescription>
          </DialogHeader>
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center gap-2 p-3 bg-yellow-50 border border-yellow-200 rounded-lg">
                ...
                <p className="text-sm text-yellow-800">
                  Esta acción no se puede deshacer. Se recomienda crear un backup actual antes de proceder.
                </p>
              </div>
            </div>
          )}
