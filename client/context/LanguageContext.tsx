...
const translations = {
  es: {
    ...
    "placeholder.describeSyptoms":
      "Describa detalladamente los síntomas principales",
    "placeholder.symptomsOnset": "ej: Hace 2 días, Esta mañana",
    "placeholder.chronicConditions":
      'Liste condiciones médicas crónicas conocidas o escriba "Ninguna"',
    "placeholder.previousHospitalizations":
      "Describa hospitalizaciones previas y fechas aproximadas",
  ...
  en: {
    ...
    "medical.completeSteps":
      "Complete the following steps to submit the referral",
    ...
    "placeholder.describeSyptoms":
      "Describe in detail the main symptoms presented by the patient",
    "placeholder.symptomsOnset": "e.g.: 2 days ago, This morning",
    "placeholder.chronicConditions":
      'List known chronic medical conditions or write "None"',
    "placeholder.previousHospitalizations":
      "Describe previous hospitalizations and approximate dates",
