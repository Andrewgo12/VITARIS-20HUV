        ...
        <div className="space-y-12">
          ...
          <div className="text-center">
            <Card className="inline-block bg-gradient-to-r from-blue-600 to-indigo-600 text-white max-w-md">
              <CardContent className="p-6">
                ...
                <p className="text-sm opacity-90">Punto de entrada único al sistema</p>
                <div className="text-xs mt-2 bg-white/20 rounded px-2 py-1">nginx / Express Gateway</div>
              </CardContent>
            </Card>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-5xl mx-auto">
            ...
            <Card className="bg-gradient-to-r from-green-500 to-emerald-600 text-white">
              <CardContent className="p-6 text-center">
                ...
                <div className="text-xs mt-2 space-y-1">
                  <div className="bg-white/20 rounded px-2 py-1">JWT Tokens</div>
                  <div className="bg-white/20 rounded px-2 py-1">2FA Opcional</div>
                </div>
              </CardContent>
            </Card>
            ...
            <Card className="bg-gradient-to-r from-orange-500 to-red-500 text-white">
              <CardContent className="p-6 text-center">
                ...
                <div className="text-xs mt-2 space-y-1">
                  <div className="bg-white/20 rounded px-2 py-1">Roles: EPS, HUV, Admin</div>
                  <div className="bg-white/20 rounded px-2 py-1">ACL Granular</div>
                </div>
              </CardContent>
            </Card>
            ...
            <Card className="bg-gradient-to-r from-purple-500 to-violet-600 text-white">
              <CardContent className="p-6 text-center">
                ...
                <div className="text-xs mt-2 space-y-1">
                  <div className="bg-white/20 rounded px-2 py-1">Session Store</div>
                  <div className="bg-white/20 rounded px-2 py-1">Token Refresh</div>
                </div>
              </CardContent>
            </Card>
          </div>
          ...
          <div>
            <div className="text-center mb-8">
              <Badge className="bg-slate-600 text-white text-lg px-4 py-2">MICROSERVICIOS CORE</Badge>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 max-w-7xl mx-auto">
              ...
              <Card className="bg-gradient-to-br from-green-500 to-emerald-500 text-white">
                <CardContent className="p-6">
                  ...
                  <h3 className="font-bold text-center mb-2">Referral Service</h3>
                  <div className="text-xs space-y-1">
              ...
              <Card className="bg-gradient-to-br from-purple-500 to-pink-500 text-white">
                <CardContent className="p-6">
                  ...
                  <h3 className="font-bold text-center mb-2">Patient Service</h3>
                  <div className="text-xs space-y-1">
              ...
              <Card className="bg-gradient-to-br from-orange-500 to-red-500 text-white">
                <CardContent className="p-6">
                  ...
                  <h3 className="font-bold text-center mb-2">Document Service</h3>
                  <div className="text-xs space-y-1">
          ...
          <div>
            <div className="text-center mb-8">
              <Badge className="bg-indigo-600 text-white text-lg px-4 py-2">SERVICIOS DE SOPORTE</Badge>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-5xl mx-auto">
              ...
              <Card className="bg-gradient-to-br from-yellow-500 to-orange-500 text-white">
                <CardContent className="p-6">
                  ...
                  <h3 className="font-bold text-center mb-2">Notification Service</h3>
                  <div className="text-xs space-y-1">
              ...
              <Card className="bg-gradient-to-br from-teal-500 to-cyan-500 text-white">
                <CardContent className="p-6">
                  ...
                  <h3 className="font-bold text-center mb-2">Validation Service</h3>
                  <div className="text-xs space-y-1">
          ...
          <div>
            ...
            <div className="text-center mb-8">
              <Badge className="bg-green-600 text-white text-lg px-4 py-2">CAPA DE DATOS</Badge>
            </div>
          ...
          <div>
            <div className="text-center mb-8">
              <Badge className="bg-orange-600 text-white text-lg px-4 py-2">INTEGRACIONES EXTERNAS</Badge>
            </div>
          ...
          <div className="mt-16">
            ...
            <div className="max-w-6xl mx-auto">
              <Card className="bg-gradient-to-br from-slate-50 to-blue-50 border-2 border-slate-200">
                <CardHeader>
                  <CardTitle className="text-center text-xl">Documentación de APIs</CardTitle>
                </CardHeader>
                <CardContent className="p-8">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    ...
                    {/* Autenticación */}
                    <div>
                      <h3 className="font-bold text-lg mb-4 text-green-700">🔐 Autenticación</h3>
                      <div className="space-y-2 text-sm font-mono">
                        <div className="p-2 bg-green-100 rounded border">
                          <span className="text-green-800 font-bold">POST</span> /api/auth/login
                        </div>
                        <div className="p-2 bg-blue-100 rounded border">
                          <span className="text-blue-800 font-bold">POST</span> /api/auth/refresh
                        </div>
                        <div className="p-2 bg-red-100 rounded border">
                          <span className="text-red-800 font-bold">POST</span> /api/auth/logout
                        </div>
                        <div className="p-2 bg-purple-100 rounded border">
                          <span className="text-purple-800 font-bold">GET</span> /api/auth/profile
                        </div>
                      </div>
                    </div>
                    ...
                    {/* Remisiones */}
                    <div>
                      <h3 className="font-bold text-lg mb-4 text-blue-700">📋 Remisiones</h3>
                      <div className="space-y-2 text-sm font-mono">
                        <div className="p-2 bg-green-100 rounded border">
                          <span className="text-green-800 font-bold">POST</span> /api/referrals
                        </div>
                        <div className="p-2 bg-blue-100 rounded border">
                          <span className="text-blue-800 font-bold">GET</span> /api/referrals
                        </div>
                        <div className="p-2 bg-yellow-100 rounded border">
                          <span className="text-yellow-800 font-bold">PUT</span> /api/referrals/:id
                        </div>
                        <div className="p-2 bg-purple-100 rounded border">
                          <span className="text-purple-800 font-bold">GET</span> /api/referrals/:id
                        </div>
                      </div>
                    </div>
                    ...
                    {/* Pacientes */}
                    <div>
                      <h3 className="font-bold text-lg mb-4 text-purple-700">👤 Pacientes</h3>
                      <div className="space-y-2 text-sm font-mono">
                        <div className="p-2 bg-green-100 rounded border">
                          <span className="text-green-800 font-bold">POST</span> /api/patients
                        </div>
                        <div className="p-2 bg-blue-100 rounded border">
                          <span className="text-blue-800 font-bold">GET</span> /api/patients/:id
                        </div>
                        <div className="p-2 bg-yellow-100 rounded border">
                          <span className="text-yellow-800 font-bold">PUT</span> /api/patients/:id
                        </div>
                        <div className="p-2 bg-purple-100 rounded border">
                          <span className="text-purple-800 font-bold">POST</span> /api/patients/:id/vitals
                        </div>
                      </div>
                    </div>
                    ...
                    {/* Documentos */}
                    <div>
                      <h3 className="font-bold text-lg mb-4 text-orange-700">📄 Documentos</h3>
                      <div className="space-y-2 text-sm font-mono">
                        <div className="p-2 bg-green-100 rounded border">
                          <span className="text-green-800 font-bold">POST</span> /api/documents/upload
                        </div>
                        <div className="p-2 bg-blue-100 rounded border">
                          <span className="text-blue-800 font-bold">GET</span> /api/documents/:id
                        </div>
                        <div className="p-2 bg-yellow-100 rounded border">
                          <span className="text-yellow-800 font-bold">PUT</span> /api/documents/:id/verify
                        </div>
                        <div className="p-2 bg-red-100 rounded border">
                          <span className="text-red-800 font-bold">DELETE</span> /api/documents/:id
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  {/* WebSockets */}
                  <div className="mt-8">
                    <h3 className="font-bold text-lg mb-4 text-cyan-700">⚡ Real-time (WebSockets)</h3>
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm">
                      ...
                      <div className="bg-green-50 p-4 rounded border border-green-200">
                        <div className="font-semibold mb-2">Dashboard Updates:</div>
          ...
          <div className="mt-12">
            <Card className="max-w-6xl mx-auto bg-gradient-to-r from-indigo-50 to-purple-50 border-2 border-indigo-200">
              <CardHeader>
                <CardTitle className="text-center">🛠️ Stack Tecnológico Recomendado</CardTitle>
              </CardHeader>
              <CardContent>
          ...
          <div className="mt-12">
            <Card className="max-w-4xl mx-auto bg-gradient-to-r from-emerald-50 to-green-50 border-2 border-emerald-200">
              <CardHeader>
                <CardTitle className="text-center">📈 Métricas de Rendimiento Esperadas</CardTitle>
              </CardHeader>
              <CardContent>
