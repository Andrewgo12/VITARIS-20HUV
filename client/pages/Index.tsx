        ...
        <div className="container mx-auto px-4 py-4 relative z-10">
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="text-center mb-6">
              ...
              <div className="bg-white/95 backdrop-blur-lg rounded-2xl p-6 shadow-xl border-0 max-w-4xl mx-auto mb-6 relative overflow-hidden transition-all duration-200 hover:shadow-2xl">
                ...
                <div className="flex items-center justify-center gap-6 mb-4">
                  {/* EPS Icon */}
                  <div className="w-16 h-16 bg-primary rounded-2xl flex items-center justify-center shadow-xl transition-all duration-200 hover:scale-105">
                    <svg
                  ...
                  <div className="text-center">
                    <div className="flex items-center justify-center gap-4 mb-3">
                      <div className="w-14 h-14 bg-red-500 rounded-xl flex items-center justify-center shadow-lg transition-all duration-200 hover:scale-105">
                        <svg
                    ...
                    <div className="flex items-center justify-center gap-4">
                      <div className="flex items-center gap-2 bg-emerald-500 px-3 py-2 rounded-full border-2 border-emerald-600 shadow-md transition-all duration-200 hover:scale-105">
                      ...
                      <div className="flex items-center gap-2 bg-blue-500 px-3 py-2 rounded-full border-2 border-blue-600 shadow-md transition-all duration-200 hover:scale-105">
                  ...
                  {/* HUV Icon */}
                  <div className="w-16 h-16 bg-emerald-500 rounded-2xl flex items-center justify-center shadow-xl transition-all duration-200 hover:scale-105">
                    <svg
                      className="w-8 h-8 text-white drop-shadow-sm"
                      fill="none"
                      stroke="currentColor"
              ...
              {/* Call to Action */}
              <div className="bg-red-500 rounded-xl p-4 max-w-2xl mx-auto shadow-lg text-white relative overflow-hidden transition-all duration-200 hover:shadow-xl">
