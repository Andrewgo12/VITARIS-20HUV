...
export default function MedicalTools() {
  ...
  const [heartRateValues, setHeartRateValues] = useState({ age: "", restingHR: "" });
  ...
  const calculateBMI = () => {
    ...
    if (weight > 0 && height > 0) {
      ...
      if (bmi < 18.5) {
        category = "Bajo peso";
        color = "text-blue-600";
        recommendation = "Consultar con nutricionista para plan de aumento de peso";
      } else if (bmi < 25) {
        ...
        <Tabs defaultValue="calculators" className="space-y-6">
                ...
                <CardContent className="space-y-4">
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      onChange={(e) => setBmirValues(prev => ({ ...prev, weight: e.target.value }))}
                    />
                  </div>
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      onChange={(e) => setBmirValues(prev => ({ ...prev, height: e.target.value }))}
                    />
                  </div>
                ...
                <CardContent className="space-y-4">
                  <div className="grid grid-cols-2 gap-4">
                    <div className="text-center p-3 bg-red-50 rounded-lg">
                      ...
                      <div className="text-sm text-muted-foreground">FC Normal</div>
                    ...
                    <div className="text-center p-3 bg-blue-50 rounded-lg">
                      ...
                      <div className="text-sm text-muted-foreground">PA Normal</div>
                    ...
                    <div className="text-center p-3 bg-orange-50 rounded-lg">
                      ...
                      <div className="text-sm text-muted-foreground">T° Normal</div>
                      <div className="text-lg font-bold">36.5-37.2</div>
                      <div className="text-xs">°C</div>
                    </div>
                    <div className="text-center p-3 bg-cyan-50 rounded-lg">
                      <div className="w-6 h-6 bg-cyan-500 rounded-full mx-auto mb-1 flex items-center justify-center text-white text-xs font-bold">O2</div>
                      <div className="text-sm text-muted-foreground">SpO2 Normal</div>
                  ...
                  <Alert>
                    ...
                    <AlertDescription className="text-sm">
                      <strong>Valores de referencia:</strong> Estos son rangos normales para adultos en reposo.
                    </AlertDescription>
                  </Alert>
                </CardContent>
              </Card>
                ...
                <CardContent className="space-y-4">
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      onChange={(e) => setDosageValues(prev => ({ ...prev, weight: e.target.value }))}
                    />
                  </div>
                  <div className="space-y-2">
                    <Label htmlFor="medication">Medicamento</Label>
                    <Select value={dosageValues.medication} onValueChange={(value) => setDosageValues(prev => ({ ...prev, medication: value }))}>
                      <SelectTrigger>
                  ...
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      onChange={(e) => setDosageValues(prev => ({ ...prev, dosagePerKg: e.target.value }))}
                    />
                  </div>
                    ...
                    <Alert className="mt-4">
                      ...
                      <AlertDescription>
                        <div className="space-y-2">
                          ...
                          <div className="text-sm">
                            {dosageResult.medication} - {dosageResult.dosagePerKg} mg/kg para {dosageResult.weight} kg
                          </div>
                        </div>
                      </AlertDescription>
                    </Alert>
                  ...
                  <div className="space-y-4">
                    <div className="space-y-2">
                      ...
                      <Input
                        ...
                        onChange={(e) => setHeartRateValues(prev => ({ ...prev, age: e.target.value }))}
                      />
                    </div>
                    <div className="space-y-2">
                      ...
                      <Input
                        ...
                        onChange={(e) => setHeartRateValues(prev => ({ ...prev, restingHR: e.target.value }))}
                      />
                    </div>
                  ...
                  {heartRateResult && (
                    <div className="md:col-span-2 space-y-4">
                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        {Object.entries(heartRateResult.zones).map(([key, zone]: [string, any]) => (
                          <div key={key} className={`p-4 rounded-lg ${zone.color}`}>
                            <div className="font-medium">{zone.name}</div>
                            <div className="text-lg font-bold">{zone.min} - {zone.max} lpm</div>
                          </div>
                        ))}
                      </div>
                    </div>
          ...
          <TabsContent value="times" className="space-y-6">
                  ...
                  <Card key={index}>
                    ...
                    <CardContent className="space-y-4">
                      <div className="text-center p-6 bg-gradient-to-br from-red-50 to-orange-50 rounded-lg">
                        ...
                        <div className="text-3xl font-bold text-red-600">{time.timeWindow}</div>
                        <div className="text-sm text-muted-foreground mt-1">Ventana terapéutica</div>
                      </div>
            ...
            <Alert className="mt-6">
              ...
              <AlertDescription>
                <strong>Nota importante:</strong> Estos tiempos son ventanas críticas donde la intervención 
