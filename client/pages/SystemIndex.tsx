...
const mainPages = [
  {
    ...
    title: "Landing Page",
    description:
      "Página principal del sistema con información completa sobre la plataforma de remisión médica",
    icon: Home,
    route: "/",
  ...
  },
  {
    ...
    description:
      "Sistema de autenticación para EPS y HUV con validación de credenciales y tipos de usuario",
    icon: LogIn,
    route: "/login",
  ...
  },
  {
    ...
    description:
      "Wizard completo de remisión médica con 5 pasos para envío de pacientes al HUV",
    icon: UserCheck,
    route: "/eps-form",
  ...
  },
  {
    ...
    title: "Dashboard HUV",
    description:
      "Panel médico para gestión, evaluación y autorización de remisiones recibidas",
    icon: Hospital,
    route: "/huv-dashboard",
...
const modalPages = [
  {
    ...
    description:
      "Vista general de todos los modales del sistema con navegación individual",
    icon: Layers,
    route: "/modales",
  ...
  },
  {
    ...
    description:
      "Datos básicos del paciente, EPS, contacto de emergencia y evaluación clínica inicial",
    icon: User,
  ...
  },
  {
    ...
    description:
      "Motivo de remisión, diagnósticos CIE10 e historial médico previo",
    icon: FileText,
  ...
  },
  {
    ...
    description:
      "Signos vitales principales, mediciones adicionales y archivos de soporte",
    icon: Activity,
  ...
  },
  {
    ...
    description:
      "Información del profesional, observaciones y archivos adjuntos",
    icon: Upload,
        ...
        <div className="container mx-auto px-6 py-8">
          <div className="text-center">
            ...
            <p className="text-lg text-slate-600 max-w-3xl mx-auto leading-relaxed">
              ...
              Explora cada componente individualmente para revisión y
              desarrollo.
            </p>
          </div>
        </div>
            ...
            <div className="text-center">
              ...
              <div className="mt-6 pt-6 border-t border-slate-200">
                <p className="text-slate-600 max-w-2xl mx-auto leading-relaxed">
                  Sistema completo de remisión médica desarrollado para la
                  gestión eficiente entre Entidades Promotoras de Salud (EPS) y
                  el Hospital Universitario del Valle. Todas las vistas incluyen
                  datos de ejemplo para facilitar la revisión.
                </p>
              </div>
            </div>
          </CardContent>
