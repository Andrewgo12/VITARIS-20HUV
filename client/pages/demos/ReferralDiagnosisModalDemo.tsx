        ...
        <div className="container mx-auto px-4 py-8">
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-muted-foreground">
                  Vista de demostración del modal de diagnóstico médico y referencia
                </p>
              </div>
            </div>
            ...
            <Card>
              ...
              <CardContent>
                <p className="text-sm text-muted-foreground">
                  Modal especializado para capturar información médica detallada, 
                  incluyendo diagnóstico, historia clínica y justificación de la remisión.
                </p>
              </CardContent>
            </Card>
          ...
          <Card className="max-w-4xl mx-auto">
            <CardHeader className="text-center">
              ...
              <p className="text-muted-foreground">
                Haz clic en el botón para abrir el modal de diagnóstico con un caso médico completo de ejemplo
              </p>
            </CardHeader>
            <CardContent className="text-center space-y-6">
              <div className="bg-gradient-to-r from-red-50 to-orange-50 p-8 rounded-lg">
                ...
                <h3 className="text-xl font-semibold mb-2">Modal de Diagnóstico Médico</h3>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-left">
                ...
                <div className="bg-slate-50 p-4 rounded-lg">
                  ...
                  <div className="text-sm text-muted-foreground space-y-1">
                    <div><code>ReferralDiagnosisModal.tsx</code></div>
              ...
              <div className="bg-blue-50 p-4 rounded-lg text-left">
                <h4 className="font-semibold mb-2">Resumen del Caso de Ejemplo</h4>
                <p className="text-sm text-muted-foreground">
                  <strong>Paciente:</strong> Mujer de 67 años con dolor torácico agudo, 
                  cambios electrocardiográficos sugestivos de STEMI anterior extenso. 
                  Antecedentes de HTA y DM2. Requiere manejo especializado urgente 
                  para consideración de reperfusión coronaria.
                </p>
              </div>
            </CardContent>
          </Card>
