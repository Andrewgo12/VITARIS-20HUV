...
export const useMedicalResponsive = () => {
  ...
  return {
    ...
    modalWidth: responsive.isMobile
      ? "95%"
      : responsive.isTablet
        ? "80%"
        : "60%",
...
export const getResponsiveTextSize = (
  context: "title" | "subtitle" | "body" | "caption",
) => {
  switch (context) {
    case "title":
...
export const getMedicalCardLayout = (
  type: "patient" | "vital" | "medication" | "alert",
) => {
...
export const getResponsiveImageSize = (
  context: "avatar" | "thumbnail" | "preview" | "full",
) => {
